...
//! 무조건 두개 다 동기화해야합니다.
// 오브젝트 리스트 이름
static const char* Objectnames[] = { "StartPoint", "SimpleTestObject","Bottle1","Bottle2", "HeadHunter"};
// 오브젝트 이미지 이름
static const char* ObjectImagenames[] = { "TestPlayer", "rocket", "spr_beer_bottle_3_0", "spr_beer_bottle_4_0", "headhunter"};
//! 무조건 두개 다 동기화해야합니다.
//!!=========================================================!!
